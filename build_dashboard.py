...
I={
 ...
 "hero_lafortuna":img("lafortuna-hero.jpg",1500),"shuttle":img("shuttle.jpg"),
 "falls":img("fortuna-waterfall.jpg"),"crlunch":img("cr-lunch.jpg"),"arenal":img("arenal.jpg"),
 "springs":img("hot-springs.jpg"),"crdinner":img("cr-dinner.jpg"),
}
