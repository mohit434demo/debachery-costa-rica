 ...
 {"id":"jul22","tab":"Wed 22","kick":"Jul 22 · Wednesday · Day 1","title":"Fly in & land in Jaco",
  ...
  "secs":[
   {"tag":"Morning","time":"7:00 AM depart ORD","title":"Fly to San Jose (SJO)","img":I["sjo"],
    "body":"<strong>Chicago group itinerary:</strong> <strong>AA 1902</strong> ORD &rarr; DFW <strong>7:02-9:40a</strong>, 1:26 layover in Dallas, then <strong>AA 1053</strong> DFW &rarr; SJO <strong>11:06a-2:17p</strong>. (NYC crew routes in separately.)",
   ...
   {"tag":"Night","time":"Late","title":"Chill at the Airbnb","img":I["chill"],
    "body":"Back at the house: pool, drinks, and getting settled. Keep it reasonable - the La Fortuna pickup is 6 AM sharp.",
    "facts":["Pool hang","6 AM pickup","Rest up"],"map":"C.+Bohio,+Jaco,+61101,+Puntarenas,+Costa+Rica","rest":"Late · settle in, plan the 6 AM La Fortuna pickup"},
 ]},
]
...
for d in days:
    ...
    panels+=f'''<section class="panel" id="{d['id']}"><header class="hero"><img src="{hero}"><div class="sc"></div><div class="ht"><div class="brand">Manish &amp; Sags DeBACHery</div><div class="kick">{d['kick']}</div><h1>{d['title']}</h1><div class="chips">{''.join(f'<span class="chip">{c}</span>' for c in d['chips'])}</div></div></header><main class="wrap">{cards}<div class="foot">Manish &amp; Sags DeBACHery · Costa Rica · Jul 22-26 · tap any spot for Maps</div></main></section>'''
